...
import { hashPin } from '@/lib/mecanico-auth';

export const dynamic = 'force-dynamic';

type RouteContext = { params: Promise<{ id: string }> };

/** POST: define/substitui PIN de um mecânico e ativa o acesso. */
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  // Retorna o PIN em texto puro APENAS nesta resposta (pra admin anotar/avisar o mecânico)
