...
export default async function MecanicoLayout({ children, params }: Props) {
  ...
  return (
    <>
      ...
      <link rel="manifest" href="/api/mecanico/manifest.webmanifest" />
      ...
      <ToastProvider>
        <div className="mecanico-app">{children}</div>
      </ToastProvider>
    </>
  );
}
